  ...
  <body class="theme-red">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        $page = 1;
        $limit = 10;
        $arrs_list = mysqli_query($conn, "select * from lechidung_users where user_level = 2;");
        ...
        $start = ($page - 1) * $limit;
        $sql = "select * from lechidung_users where user_level = 2 ORDER BY user_id DESC limit " . $start . "," . $limit . " ;";
        $result = mysqli_query($conn, $sql);
        if (mysqli_num_rows($result) > 0) {
        ...
        <div class="row">
          <div class="col-12 col-md-12">
            <div class="JustifyCenter">
              <ul class="pagination">
                <li><a href="../../../app/admin/user/display.php?page=<?php echo $page - 1; ?>">Previous</a></li>
                <?php for ($i = 1; $i <= $total_page; $i++) { ?>
                  <li <?php if ($page == $i) echo "class='active'"; ?>><a href="../../../app/admin/user/display.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                <?php } ?>
                <li><a href="../../../app/admin/user/display.php?page=<?php echo $page + 1; ?>">Next</a></li>
              </ul>
            </div>
          </div>
        </div>
